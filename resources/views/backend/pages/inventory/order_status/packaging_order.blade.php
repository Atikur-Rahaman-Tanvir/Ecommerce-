                            ...
                            <div class="white_card_body">
                                <div class="QA_section">
                                    <div class="white_box_tittle list_header">
                                        <h4>All Order Packaging<span class="badge  bg-primary"></span></h4>
                                        ...
                                        <div class="col-lg-12">
                                            <div class="white_card card_height_100 ">
                                                <div class="white_card_body">
                                                    ...
                                                    <div class=" mb-0 bg-danger p-2"
                                                        style="width:200px;display:inline-block;">
                                                        Total Order Packaging :
                                                        {{ $orders->where('order_status', 'Packaging')->count() }}
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#search_box').keyup(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.order.status.packaging.search') }}",
                    data: {
                        'data': data
                    },
            ...
            $('#inputDate').change(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.order.status.packaging.date.search') }}",
                    data: {
                        'date': date
                    },
                    success: function(response) {
