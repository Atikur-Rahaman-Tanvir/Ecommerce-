                        ...
                        <div class="white_card_body">
                            <div class="QA_section">
                                <div class="white_box_tittle list_header">
                                    <h4>All Delivered Order<span class="badge  bg-primary"></span></h4>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="action_btns d-flex">
                                                        <a href="{{ route('admin.order.details', $order->id) }}" class="action_btn mr_10"> <i class="far fa-eye"></i>
                                                        </a>

                                                        <a id="{{ $order->id }}" class="action_btn delete" data-bs-toggle="modal" data-bs-target="#delete_modal">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <button type="button" class="btn btn-primary mt-5" style="float: right; margin-right:5px" id="cancle_delete">Cancle</button>
                </form>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function() {
        $('#search_box').keyup(function() {
            ...
            $.ajax({
                type: 'get',
                url: "{{ route('admin.order.status.delivered.search') }}",
                data: {
                    'data': data
                },
        ...
        $('#inputDate').change(function() {
            ...
            $.ajax({
                type: 'get',
                url: "{{ route('admin.order.status.delivered.date.search') }}",
                data: {
                    'date': date
                },
                success: function(response) {
