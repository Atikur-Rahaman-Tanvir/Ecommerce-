                            ...
                            <div class="white_card_body">
                                <div class="QA_section">
                                    <div class="white_box_tittle list_header">
                                        <h4>All Shipped Order<span class="badge  bg-primary"></span></h4>
                                            ...
                                            <div class="white_card card_height_100 ">
                                                <div class="white_card_body">
                                                    ...
                                                    <div class=" mb-0 bg-danger p-2"
                                                        ...
                                                        Total Shipped Order  :
                                                        {{ $orders->where('order_status', 'Shipped')->count() }}
                                                    </div>
    ...
    <script>
        $(document).ready(function() {
            $('#search_box').keyup(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.order.status.shipped.search') }}",
                    data: {
                        'data': data
                    },
            ...
            $('#inputDate').change(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.order.status.shipped.date.search') }}",
                    data: {
                        'date': date
                    },
                    success: function(response) {
