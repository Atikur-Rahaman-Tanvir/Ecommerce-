...
@section('content')
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                ...
                                                                <a id="{{ $Tag->id }}" class="action_btn mr_10 edit "
                                                                    data-bs-toggle="modal" data-bs-target="#edit_modal"> <i
                                                                        class="far fa-edit"></i> </a>


                                                                <a id="{{ $Tag->id }}" class="action_btn delete"
                        ...
                        <div class="col-lg-12">
                            <div class="white_card card_height_100 ">
                                ...
                                <div class="white_card_body">
                                    ...
                                    <p><cite>Tag name must be unique.</cite></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Tag Edit And Update</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
