...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add New Shipping Method</h5>
                                ...
                                <div class="white_card_header">
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            <h3 class="m-0">Shipping Method Name</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="white_card_body">
                                    ...
                                    <p><cite>shipping method name must be unique.</cite></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="white_card card_height_100 ">
                                <div class="white_card_header">
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            <h3 class="m-0">Shipping Price</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="white_card_body">
                                    ...
                                    <p><cite>set price for shipping.</cite></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="white_card card_height_100 ">
                                <div class="white_card_header">
                                    <div class="box_header m-0">
                                        <div class="main-title">
                                            <h3 class="m-0">Delevery Days</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="white_card_body">
                                    <span class="text-danger delivery_days_error"></span>
                                    <div class=" mb-0">
                                        <input type="text" class="form-control" name="delivery_days" id="delivery_days"
                                            placeholder="Shipping Delivery Days">
                                    </div>
                                    <p><cite>how to days need to  delivery.</cite></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Shipping Method Edit And Update</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                        ...
                        <div class="col-lg-12">
                            <div class="white_card card_height_100 ">
                                ...
                                <div class="white_card_body">
                                    <span class="text-danger delivery_days_error"></span>
                                    <div class=" mb-0">
                                        <input type="text" class="form-control" name="delivery_days" id="edit_delivery_days"
                                            placeholder="Shipping Delivery Days">
                                    </div>
                                    <p><cite>how to days need to  delivery.</cite></p>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#insert_form').submit(function(e){
                ...
                $.ajax({
                    type:"post",
                    url:"{{route('admin.shipping.method.store')}}",
                    data:insert_data,
                    contentType: false,
                    processData: false,
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.shipping.method.show') }}",
                    data: {
                        'id': id
                    },
                    dataType: "json",
                    success: function(response) {
                        $('#edit_id').val(response.shipping_method.id);
                        $('#edit_name').val(response.shipping_method.name);
                        $('#edit_price').val(response.shipping_method.price);
                        $('#edit_delivery_days').val(response.shipping_method.delivery_days);
                    }
                });
            });
            ...
            $('#edit_form').submit(function(e) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "{{ route('admin.shipping.method.edit') }}",
                    data: formdata,
                    contentType: false,
                    processData: false,
                    success: function(response) {
            ...
            $(document).on('click', '#delete_confirm', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.shipping.method.delete') }}",
                    data: {
                        'id': id
                    },
                    dataType: 'json',
            ...
            $(document).on('click', '.status', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.shipping.method.status') }}",
                    data: {
                        'id': id,
                    },
                    dataType: 'json',
            ...
            $('#search_box').on('keyup', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.shipping.method.search') }}",
                    data: {
                        'search': value
                    },
                    success: function(response) {
