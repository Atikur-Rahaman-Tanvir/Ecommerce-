...
@section('content')
                                            ...
                                            <tbody id="table_body">
                                                @foreach ($colors as $color)
                                                    <tr>
                                                        ...
                                                        <td><div style="width: 40px; height:40px; background:{{ $color->color_code }};"></div></td>
                                                        <td>
                                                            @if ($color->status == 0)
                                                        ...
                                                        <td>
                                                            <div class="action_btns d-flex">
                                                                ...
                                                                <a id="{{ $color->id }}" class="action_btn mr_10 edit "
                                                                    data-bs-toggle="modal" data-bs-target="#edit_modal"> <i
                                                                        class="far fa-edit"></i> </a>


                                                                <a id="{{ $color->id }}" class="action_btn delete"
                        ...
                        <div class="col-lg-12">
                            <div class="white_card card_height_100 ">
                                ...
                                <div class="white_card_body">
                                    ...
                                    <p><cite>color name must be unique.</cite></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="white_card card_height_100 ">
                                ...
                                <div class="white_card_body">
                                    ...
                                    <span class="sp-original-input-container" style="margin: 0px 10px 10px 0px;">
                                        <div class="sp-colorize-container sp-add-on"
                                            style="width: 35px; border-radius: 4px; border: 1px solid rgb(204, 204, 204);">
                                            <div class="sp-colorize" style="background-color: #6a329f; color: white;">
                                            </div>
                                        </div>
                                        <input type="text" value="" id="color-picker"
                                            class="spectrum with-add-on form-control color_picker" name="color_picker" placeholder="click here to select color">
                                    </span>
                                    <p><cite>color code must be unique.</cite></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Color Edit And Update</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                            ...
                            <div class="white_card card_height_100 ">
                                ...
                                <div class="white_card_body">
                                    ...
                                    <span class="sp-original-input-container" style="margin: 0px 10px 10px 0px;">
                                        ...
                                        <input type="text" value="" id="color-picker1"
                                            class="spectrum with-add-on form-control color_picker edit_color_code" name="color_picker" placeholder="click here to select color">
                                    </span>
                                    <p><cite>color code must be unique.</cite></p>
                                </div>
                            </div>
