...
@section('content')
                                                            ...
                                                            <div class="action_btns d-flex">
                                                                ...
                                                                <a id="{{ $zila->id }}"
                                                                    class="action_btn mr_10 status "> <i
                                                                        class="{{ $zila->status == 0 ? 'far fa-eye-slash' : 'fa fa-eye' }}"></i>
                                                                </a>

                                                                <a id="{{ $zila->id }}" class="action_btn mr_10 edit "
                                                                    data-bs-toggle="modal" data-bs-target="#edit_modal"> <i
                                                                        class="far fa-edit"></i> </a>


                                                                <a id="{{ $zila->id }}" class="action_btn delete"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add New Zilla</h5>
                        ...
                        <div class="col-lg-12">
                            <div class="white_card card_height_100 ">
                                ...
                                <div class="white_card_body">
                                    ...
                                    <p><cite>zilla name must be unique.</cite></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Zilla Edit And Update</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.zila.show') }}",
                    data: {
                        'id': id
                    },
                    dataType: "json",
                    success: function(response) {
                        $('#edit_id').val(response.zila.id);
                        $('#edit_name').val(response.zila.name);
                    }
                });
            });
