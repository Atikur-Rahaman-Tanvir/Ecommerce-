...
@section('content')
                                                            ...
                                                            <div class="action_btns d-flex">
                                                                ...
                                                                <a id="{{ $upozila->id }}"
                                                                    class="action_btn mr_10 status "> <i
                                                                        class="{{ $upozila->status == 0 ? 'far fa-eye-slash' : 'fa fa-eye' }}"></i>
                                                                </a>

                                                                <a id="{{ $upozila->id }}" class="action_btn mr_10 edit "
                                                                    data-bs-toggle="modal" data-bs-target="#edit_modal"> <i
                                                                        class="far fa-edit"></i> </a>


                                                                <a id="{{ $upozila->id }}" class="action_btn delete"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add New Upozilla</h5>
                        ...
                        <div class="col-lg-12">
                            <div class="white_card card_height_100 ">
                                ...
                                <div class="white_card_body">
                                    ...
                                    <p><cite>upozilla name must be unique.</cite></p>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="edit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Upozilla Edit And Update</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.upozila.show') }}",
                    data: {
                        'id': id
                    },
                    dataType: "json",
                    success: function(response) {
                        $('#edit_id').val(response.upozila.id);
                        $('#edit_name').val(response.upozila.name);
                    }
                });
            });
            ...
            $(document).on('click', '#delete_confirm', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.upozila.delete') }}",
                    data: {
                        'id': id
                    },
                    dataType: 'json',
            ...
            $(document).on('click', '.status', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.upozila.status') }}",
                    data: {
                        'id': id,
                    },
                    dataType: 'json',
            ...
            $('#search_box').on('keyup', function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.upozila.search') }}",
                    data: {
                        'search': value
                    },
                    success: function(response) {
