                                            ...
                                            <div class="white_card card_height_100 ">
                                                <div class="white_card_body">
                                                    ...
                                                    <div class=" mb-0 bg-danger p-2"
                                                        ...
                                                        Total COD Order :
                                                        {{ $orders->where('payment_status', 'Canceled')->count() }}
                                                    </div>
                                            ...
                                            <tbody>
                                                @foreach ($orders as $order)
                                                    <tr>
                                                        ...
                                                        <td><mark>{{ $order->payment_status }}</mark></td>
    ...
    <script>
        $(document).ready(function() {
            $('#search_box').keyup(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.payment.cod.order.search') }}",
                    data: {
                        'data': data
                    },
            ...
            $('#inputDate').change(function() {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('admin.payment.cod.order.date.search') }}",
                    data: {
                        'date': date
                    },
                    success: function(response) {
