            ...
            <tr>
                ...
                <td>
                    <div class="action_btns d-flex">
                        ...
                        <a id="{{ $size->id }}" class="action_btn mr_10 status "> <i
                                class="{{ $size->status == 0 ? 'far fa-eye-slash' : 'fa fa-eye' }}"></i>
                        </a>

                        <a id="{{ $size->id }}" class="action_btn mr_10 edit " data-bs-toggle="modal"
                            data-bs-target="#edit_modal"> <i class="far fa-edit"></i> </a>


                        <a id="{{ $size->id }}" class="action_btn delete" data-bs-toggle="modal"
