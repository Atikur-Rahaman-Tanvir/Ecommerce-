...
@section('content')
            ...
            <div id="page-content">
                ...
                <div class="breadcrumbs-wrapper text-uppercase">
                    <div class="container">
                        <div class="breadcrumbs"><a href="index-2.html" title="Back to the home page">Home</a><span>|</span><span class="fw-bold">Product Layout Style1</span></div>
                    </div>
                </div>
                <!--End Breadcrumbs-->
                ...
                <div class="container">
                    ...
                    <div class="product-single">
                        <div class="row">
                                ...
                                <div class="product-details-img thumb-left clearfix d-flex-wrap mb-3 mb-md-0">
                                    <div class="product-thumb">
                                        <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                            <a data-image="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" data-zoom-image="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" class="slick-slide slick-cloned active">
                                                <img class="blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" alt="product" />
                                            </a>
                                            <a data-image="{{asset('assets/frontend/assets')}}/images/products/product-6-2.jpg" data-zoom-image="{{asset('assets/frontend/assets')}}/images/products/product-6-2.jpg" class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-6-2.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-6-2.jpg" alt="product" />
                                            </a>
                                            <a data-image="{{asset('assets/frontend/assets')}}/images/products/product-6-3.jpg" data-zoom-image="{{asset('assets/frontend/assets')}}/images/products/product-6-3.jpg" class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-6-3.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-6-3.jpg" alt="product" />
                                            </a>
                                            <a data-image="{{asset('assets/frontend/assets')}}/images/products/product-6-4.jpg" data-zoom-image="{{asset('assets/frontend/assets')}}/images/products/product-6-4.jpg" class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-6-4.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-6-4.jpg" alt="product" />
                                            </a>
                                            <a data-image="{{asset('assets/frontend/assets')}}/images/products/product-6-5.jpg" data-zoom-image="{{asset('assets/frontend/assets')}}/images/products/product-6-5.jpg" class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-6-5.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-6-5.jpg" alt="product" />
                                            </a>
                                            <a data-image="{{asset('assets/frontend/assets')}}/images/products/product-6-6.jpg" data-zoom-image="{{asset('assets/frontend/assets')}}/images/products/product-6-6.jpg" class="slick-slide slick-cloned">
                                                <img class="blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-6-6.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-6-6.jpg" alt="product" />
                                            </a>
                                        </div>
                                    </div>
                                    <div class="zoompro-wrap product-zoom-right">
                                        <div class="zoompro-span"><img id="zoompro" class="zoompro" src="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" data-zoom-image="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" alt="product" /></div>
                                    ...
                                    <div class="lightboximages">
                                        <a href="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" data-size="1000x1280"></a>
                                        <a href="{{asset('assets/frontend/assets')}}/images/products/product-6-2.jpg" data-size="1000x1280"></a>
                                        <a href="{{asset('assets/frontend/assets')}}/images/products/product-6-3.jpg" data-size="1000x1280"></a>
                                        <a href="{{asset('assets/frontend/assets')}}/images/products/product-6-4.jpg" data-size="1000x1280"></a>
                                        <a href="{{asset('assets/frontend/assets')}}/images/products/product-6-5.jpg" data-size="1000x1280"></a>
                                        <a href="{{asset('assets/frontend/assets')}}/images/products/product-6-6.jpg" data-size="1000x1280"></a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-5 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="trustseal-img mt-4"><img src="{{asset('assets/frontend/assets')}}/images/powerby-cards.jpg" alt="powerby cards" /></div>
                                <!-- End Product Info -->
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="product-layout7.html" class="product-nav prev-pro d-flex-center justify-content-between" title="Previous Product">
                        ...
                        <span class="img"><img src="{{asset('assets/frontend/assets')}}/images/products/product-7.jpg" alt="product" /></span>
                    </a>
                    <a href="product-layout2.html" class="product-nav next-pro d-flex-center justify-content-between" title="Next Product">
                        <span class="img"><img src="{{asset('assets/frontend/assets')}}/images/products/product-2.jpg" alt="product"></span>
                        <span class="details">
                                ...
                                <div class="product-description">
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-12 col-md-4 col-lg-4">
                                            <img data-src="{{asset('assets/frontend/assets')}}/images/about/about-info-s3.jpg" src="{{asset('assets/frontend/assets')}}/images/about/about-info-s3.jpg" alt="image" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="productSlider grid-products">
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-8.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-8.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-8-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-8-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                        <!-- product label -->
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-9-2.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-9-2.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-9-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-9-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-7.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-7.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-7-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-7-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                                    <!--Product label-->
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-6.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-6.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-6-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-10.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-10.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-10-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-10-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                        ...
                        <div class="productSlider grid-products">
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-11.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-11.jpg" alt="image" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-11-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-11-1.jpg" alt="image" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-12.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-12.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-12-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-12-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-13.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-13.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-13-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-13-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                                    <!--Product label-->
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-14.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-14.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-14-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-14-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                            ...
                            <div class="item">
                                ...
                                <div class="product-image">
                                    ...
                                    <a href="product-layout1.html" class="product-img">
                                        <!-- image -->
                                        <img class="primary blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-15.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-15.jpg" alt="" title="">
                                        <!-- End image -->
                                        <!-- Hover image -->
                                        <img class="hover blur-up lazyload" data-src="{{asset('assets/frontend/assets')}}/images/products/product-15-1.jpg" src="{{asset('assets/frontend/assets')}}/images/products/product-15-1.jpg" alt="" title="">
                                        <!-- End hover image -->
                                    </a>
                                    <!--End Product Image-->
                                    <!--Product Button-->
