                   <div class="grid-products grid--view-items prd-grid shop_product">
                                    ...
                                    <div class="product-image">
                                        ...
                                        <a href="{{ route('product.details', $product->id) }}" class="product-img">
                                            ...
                                            <img class="primary blur-up lazyload"
                                                data-src="{{ asset('storage/product_image/' . $product->image) }}"
                                        ...
                                        {{-- <div class="button-set style0 d-none d-md-block">
                                            <ul>
                                                <!--Cart Button-->
                                                <li><a id="{{$product->id}}" class="btn-icon btn cartIcon pro-quickshop-popup product_add_to_cart"><i
                                                ...
                                                <li><a class="btn-icon quick-view-popup quick-view"
                                                        ...
                                                        <span class="tooltip-label top">Quick
                                                            View</span></a></li>
                                                ...
                                                <form method="post" action="#" id="product_form_1052"
                                                    ...
                                                    <div class="product-single__price lh-1 mb-3 mt-0 mx-auto">
                                                        ...
                                                        <span class="product-price__sale--single">
                                                            <span
                                                                ...
                                                                class="product-price__price product-price__sale0">${{ $product->price }}</span>
                                                        </span>
                                                    </div>
                                                    <!-- End Product Price -->
                                                    <!-- Swatches Color -->
                                                    ...
                                                    <div class="product-form-submit mx-auto">
                                                        <button type="submit" name="add"
                                                            class="btn rounded product-form__cart-submit btn-small px-3"><span>Add
                                                                to
                                                                cart</span></button>
                                                        <button type="submit" name="add"
                                        ...
                                        <div class="product-price">
                                            @if ($product->discount)
                                                ...
                                                <span class="price text-danger"
                                                    style="font-weight:bold;">${{ round($product->price - ($product->price * $product->discount) / 100) }}</span>
                                            @else
                                            ...
                                            <div class="addtocart-btn">
                                                <form class="addtocart" action="#" method="post">
                                                    <a class="btn pro-addtocart-popup" href="#pro-addtocart-popup"><i
                                                            class="icon hidden an an-cart-l"></i>Select Options</a>
                                                </form>
                                            </div>
                    ...
                    <div class="grid-products grid--view-items prd-grid ">
                        <div class="row price_filter_product" id="shop_product ">
                            {{-- {{ $products->links('pagination::bootstrap-5') }} --}}
                        </div>
                    </div>

                    <div class=" text-center not_found d-none"><h3 class="text-danger">No Porduct Available At The Price Range</h3></div>
